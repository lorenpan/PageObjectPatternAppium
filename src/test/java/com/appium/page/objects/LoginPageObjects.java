...
public class LoginPageObjects {
    ...
    @iOSXCUITFindBy(accessibility = "Password") @AndroidFindBy(id = "nux_password")
    ...
    @AndroidFindBy(id = "nux_add_selfhosted_button") public MobileElement add_self_site;

    @CacheLookup
    @AndroidFindBy(xpath = ".//*[@text='Log in']")
    @iOSXCUITFindBy(accessibility = "Log In Button")
    @AndroidFindBy(id = "nux_sign_in_button") @FindBy(id = "wp-submit") public MobileElement
        sign_in;

    @CacheLookup
    @AndroidFindBy(id = "org.wordpress.android:id/nux_url")
    @iOSXCUITFindBy(xpath = ".//*[@value='Site Address (URL)']") @AndroidFindBy(id = "nux_url")
